%% TileOneOne.m, 6.6.2024
% To construct a tiling with the aperiodic Tile(1,1)
% Please cite as
% "H.U. Voss, A tiling algorithm for the aperiodic monotile Tile(1,1), arXiv (2024)"
% The license attached in GitHub applies, at https://github.com/henningle/TileOneOne.git

%% Parameters

maxN=4; % Maximum iteration. The largest maxN tested was maxN=8 (16,908,641 tiles)

plotkeypoints=true; % Set to false if plotting key points not wanted
...
for N=1:maxN
    ...
    plotting=0; if N==maxN; plotting=1; end % Plot only the last iteration
...
save(['TileOneOne_Ni' num2str(N) '.mat'], "S");
